        ...
        function calculateScore() {
            ...
            const totalPossible = selectedQuestions.length * 20;
...
function showWrongAnswers() {
    ...
    // 修改弹窗样式为100%大小
    wrongAnswersModal.style.display = 'block';
    wrongAnswersModal.style.width = '100%';
    wrongAnswersModal.style.height = '100%';
    wrongAnswersModal.style.margin = '0';
    wrongAnswersModal.style.padding = '0';
